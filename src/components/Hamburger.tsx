...
const menuLinks = [
  ...
  { label: "Residential", href: "/RealEstatePage#residential" },
  {
    ...
    href: "/RealEstatePage#construction-material",
  },
...
const socialIcons = [
  {
    label: "LinkedIn",
    icon: (
      <svg width="25" height="25" viewBox="0 0 24 24" fill="black">
